        ...
        <div class="card shadow-sm rounded">
            <div class="card-header py-3 bg-danger border-bottom">
                <div class="d-flex align-items-center">
                    ...
                    <h5 class="mb-0 fw-bold text-white">Machine Details</h5>
                </div>
                {{ $slot }}
            </div>
            <div class="card-body p-3">
                <div class="d-flex flex-wrap justify-content-between w-100 w-md-75 mx-auto text-center gap-3">
                    ...
                    <div class="d-flex align-items-center flex-grow-1 flex-md-nowrap flex-wrap">
                        ...
                        <div>
                            <h6 class="text-start text-dark fs-6 fw-bold mb-1">Name</h6>
                            <p class="text-start text-secondary fs-6 fw-semibold mb-0">{{ $name ?? 'N/A' }}</p>
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center flex-grow-1 flex-md-nowrap flex-wrap">
                        ...
                        <div>
                            <h6 class="text-start text-dark fs-6 fw-bold mb-1">Line</h6>
                            <p class="text-start text-secondary fs-6 fw-semibold mb-0">{{ $line ?? 'N/A' }}</p>
                        </div>
                    </div>
