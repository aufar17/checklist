@props(['machines', 'machine_items', 'inspections','daysInMonth'])
...
<div class="table-responsive" style="overflow-x: auto;">
    <table class="table table-striped table-hover" style="width: 100%;">
        ...
        <tbody>
            ...
            {{-- Baris Pemeriksa Shift 2 --}}
            @foreach (['PIC Maintenance', 'Line Guide', 'Foreman Produksi'] as $role)
            <tr>
                <td colspan="4" style="font-weight: bold;">Dicek Setiap (Shift 2) Oleh {{ $role }}</td>
